...
export default function FinalCta() {
  return (
    <section className="mx-auto w-full max-w-[1200px] px-6 py-7 sm:px-8 sm:py-9 lg:py-14">
      <div className="relative rounded-[28px] border border-violet/30 px-7 py-14 text-center sm:px-12 lg:px-16 lg:py-20">
        {/* decorative layers — clipped to the card, never to the CTA menu */}
        <div className="pointer-events-none absolute inset-0 overflow-hidden rounded-[28px]">
          <div className="absolute inset-0 bg-gradient-to-l from-violet-deep/40 via-violet/20 to-violet-deep/40" />
          <div className="glow absolute -left-16 -top-24 h-72 w-72" />
          <div
            className="glow absolute -bottom-28 right-0 h-72 w-72"
